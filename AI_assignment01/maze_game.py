...
class Pygame_APP:
    def __init__(self, keyboard=True, scale=20, speed=30):
        ...
        self.scale = scale
        self.speed = speed
        self.windowTitle = "AI Assignment 01:"
    ...
    def drawWall(self, row, col):
        pygame.draw.rect(self.displaySurface, (40, 80, 80),(col * self.blockSizeX, row * self.blockSizeY, self.blockSizeX, self.blockSizeY), 0)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--method', dest="search", type=str, default = "bfs",
                        choices = ["bfs", "astar", "astar_four_circles", "astar_many_circles"],
